...
function Tabs:Create(name)
    ...
    B.MouseButton1Click:Connect(function()
        ...
        for _, v in pairs(TabContainer:GetChildren()) do
            if v:IsA("TextButton") then v.TextColor3 = Color3.fromRGB(150, 150, 150); v.BackgroundColor3 = Color3.fromRGB(30, 30, 30) end
        end
    ...
    function El:AddToggle(text, callback)
        ...
        F.Size = UDim2.new(1, -5, 0, 38); F.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
        ...
        T.Size = UDim2.new(0, 30, 0, 16); T.Position = UDim2.new(1, -40, 0.5, -8); T.BackgroundColor3 = Color3.fromRGB(50, 50, 50); T.Text = ""
        ...
        T.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(T, TweenInfo.new(0.15), {BackgroundColor3 = s and Color3.fromRGB(0, 255, 150) or Color3.fromRGB(50, 50, 50)}):Play()
            callback(s)
        end)
    end
    function El:AddInput(text, callback)
        local F = Instance.new("Frame", P)
        F.Size = UDim2.new(1, -5, 0, 40); F.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
        Instance.new("UICorner", F).CornerRadius = UDim.new(0, 4)
        local L = Instance.new("TextLabel", F)
        L.Size = UDim2.new(0.6, 0, 1, 0); L.Position = UDim2.new(0, 10, 0, 0); L.BackgroundTransparency = 1
        L.Font = Enum.Font.GothamSemibold; L.Text = text; L.TextColor3 = Color3.new(1, 1, 1); L.TextSize = 12; L.TextXAlignment = Enum.TextXAlignment.Left
        local Box = Instance.new("TextBox", F)
        Box.Size = UDim2.new(0, 70, 0, 24); Box.Position = UDim2.new(1, -80, 0.5, -12); Box.BackgroundColor3 = Color3.fromRGB(40, 40, 40); Box.Font = Enum.Font.GothamBold
    ...
    function El:AddButton(text, callback)
        ...
        B.Size = UDim2.new(1, -5, 0, 32); B.BackgroundColor3 = Color3.fromRGB(40, 40, 40); B.Font = Enum.Font.GothamBold; B.Text = text; B.TextColor3 = Color3.new(1, 1, 1); B.TextSize = 12
...
P1:AddToggle("Killaura (Cầm vũ khí)", function(v) Config.Killaura = v end)
        ...
        if p ~= LocalPlayer and p.Character then
            ...
            if hrp then
                if Config.Hitbox then
                    ...
                    hrp.CanCollide = false -- QUAN TRỌNG: Không để bị đẩy
                    hrp.Massless = true    -- QUAN TRỌNG: Không gây nặng vật lý
                    hrp.CanTouch = true    -- Vẫn nhận diện được cú chém
                else
